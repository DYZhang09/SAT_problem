...
@return: 被删除的文字序号
*/
short removeLiteralFromFormulaOpti(struct Formula* formula, short data, int* counter)
{
...
@return: 被删除的文字序号
*/
short removeClauseHasLiteralOpti(struct Formula* formula, short data, int* counter)
{
...
@return: 被选出的文字的序号
*/
short selectDataFromUnitClauseOpti(struct Formula* formula, int* counter)
{
